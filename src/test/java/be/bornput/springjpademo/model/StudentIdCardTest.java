...
class StudentIdCardTest {
    ...
    public void test_createNewStudentWithConstructorAndRetrieveItsProperties() {
        ...
        assertThat(studenrCardUnderTest.toString()).isEqualTo("StudentIdCard{id=1, student=Student{id=1, firstName='Andy', lastName='Mertens', email='andy.mertens@gmail.com', age=51}, cardNumber='0000XXXX'}");
        assertThat(studenrCardUnderTest).isEqualTo(studentCardToCompareWith);
        assertThat(studenrCardUnderTest.toString()).isEqualTo(studentCardToCompareWith.toString());
        assertThat(studenrCardUnderTest.hashCode()).isEqualTo(studentCardToCompareWith.hashCode());
    }
